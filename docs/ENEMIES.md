...
Default table: one Juggernaut at **150s** ("THE JUGGERNAUT APPROACHES", drops `weapon_warhammer`), one Caster at **300s** ("THE HIEROPHANT APPROACHES", drops `weapon_staff` — collecting it **wins the run**), **12 Sprinters at 45s repeating every 50s** ("A SWARM APPROACHES"), **16 Chasers at 120s repeating every 80s** ("THEY POUR IN"), and **24 Spitters at 360s repeating every 60s** ("THEY'RE EVERYWHERE").
