...
| **3. Bosses & arsenal** | 🔨 In progress | First boss via scheduled `WaveTable` events + boss health bar; first spell (Firebolt) unlocked through an ability-granting field on `UpgradeData`. Second weapon still queued. |
