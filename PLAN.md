...
res://
  ...
  data/
	enemies/       *.tres (EnemyData) — chaser, sprinter, brute, spitter, juggernaut
  ...
  actors/
	...
	enemies/       enemy_base.gd, boss_enemy.gd, ChaserEnemy/Sprinter/Brute/
				   SpitterEnemy/BossEnemy.tscn, Projectile.tscn
...
| **6+ (parked)** | — | Prestige layer, multiple arenas, achievements. |
